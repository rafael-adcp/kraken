...
class CleanupClosedTests(KrakenConformanceTest):
    def test_cleanup(self):
        ...
        r = self.kraken("cleanup", "acme/tasks", 1, env=env)
        ...
        r = self.kraken("cleanup", "acme/tasks", 2, env=env)
        ...
        r = self.kraken("cleanup", "acme/tasks", 3, env=env)
        ...
        r = self.kraken("cleanup", "acme/tasks", 4, env=env)

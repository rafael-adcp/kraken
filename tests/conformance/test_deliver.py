...
the claim ref (lock) deleted — and after a review bounce (human removes
awaiting-merge), ANY worker can claim the now-unlocked task."""
import os
import unittest
...
class DeliverTests(KrakenConformanceTest):
    def test_deliver(self):
        ...
        self.assertFalse(self.claim_ref_exists(7), "deliver left the lock behind")

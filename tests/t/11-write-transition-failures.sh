...
out="$(GH_STUB_FAIL='issue comment' python3 "$SCRIPTS/kraken.py" escalate OWNER/tasks 7 w1 "$q")"
...
out="$(GH_STUB_FAIL='issue edit' python3 "$SCRIPTS/kraken.py" escalate OWNER/tasks 7 w1 "$q")"
...
out="$(GH_STUB_FAIL='issue edit' python3 "$SCRIPTS/kraken.py" deliver OWNER/tasks 8 w1 "$r" "https://x/pr/1")"
...
out="$(GH_STUB_FAIL='issue comment' python3 "$SCRIPTS/kraken.py" heartbeat OWNER/tasks 8 w1 "still here")"

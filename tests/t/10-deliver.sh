...
c="$(last_comment 7)"
assert_marker 7 '{"type":"delivered","worker":"w1","pr":"https://github.com/owner/app/pull/9"}'
...
assert_marker 8 '{"type":"delivered","worker":"w1"}'
last_comment 8 | grep -q '"pr":' && fail "pr field present without a PR URL"

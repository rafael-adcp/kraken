#!/usr/bin/env bash
# watch-queue.sh — thin shim. The transition logic now lives in kraken.py (one
...
#
# usage: watch-queue.sh OWNER/tasks PROJECT
exec python3 "$(dirname "$0")/kraken.py" watch "$@"
